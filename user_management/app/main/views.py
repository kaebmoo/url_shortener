...
from app.main.forms import URLShortenForm
import requests
...
def shorten():
    ...
    return render_template('main/shorten.html', form=form, message=message, short_url=short_url, qr_code_base64=qr_code_base64)
